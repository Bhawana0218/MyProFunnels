  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${pastThreshold ? 'glass-card py-3 border-x-0 border-t-0 rounded-none' : 'py-6 bg-transparent'}`}>
      <div className="max-w-[1200px] mx-auto px-6 md:px-20 flex justify-between items-center">
        <div className="text-[22px] font-bold font-display tracking-tight cursor-pointer">
        ...
        <nav className="hidden md:flex items-center gap-10 text-[14px] font-medium">
          <a href="#features" className="text-[var(--color-body)] hover:text-[var(--color-teal)] transition-colors duration-300">Features</a>
          <a href="#how-it-works" className="text-[var(--color-body)] hover:text-[var(--color-teal)] transition-colors duration-300">How It Works</a>
          <a href="#about" className="text-[var(--color-body)] hover:text-[var(--color-teal)] transition-colors duration-300">About</a>
          <motion.a
            ...
            className="btn-teal px-6 py-2.5 text-[14px] no-underline"
          >
            Book Strategy Call
          </motion.a>
        </nav>
