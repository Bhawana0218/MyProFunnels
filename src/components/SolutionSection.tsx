        ...
        >
          {promises.map((promise) => (
            <motion.div
              key={promise}
              variants={fadeUp}
              className="glass-card p-[24px] flex items-center gap-[16px] h-[72px]"
            >
              <span className="w-[36px] h-[36px] rounded-xl bg-[var(--color-teal)]/10 text-[var(--color-teal)] flex items-center justify-center flex-shrink-0">
        ...
        <div ref={pipelineRef} className="relative max-w-6xl mx-auto">
          <div className="hidden md:block relative h-[200px]">
            ...
            <motion.div
              ...
              style={{ background: 'linear-gradient(90deg, #2dd4bf, #14b8a6, #2dd4bf)', backgroundSize: '200% 100%' }}
              initial={{ width: "0%" }}
            ...
            {isInView && (
              <motion.div
                ...
                style={{ background: 'linear-gradient(90deg, transparent, rgba(45,212,191,0.5), transparent)', filter: 'blur(4px)' }}
              ...
              return (
                ...
                >
                  <div className="mb-[16px] text-center">
                    ...
                    <div className="text-[14px] font-bold text-[var(--color-headline)] font-display">{node.label}</div>
                  </div>

                  <div className="relative z-10">
                    <div className="absolute inset-[-8px] rounded-full bg-[var(--color-teal)]/0 group-hover:bg-[var(--color-teal)]/10 transition-all duration-500 blur-md" />
                    <div className="w-[96px] h-[96px] rounded-full glass-card flex items-center justify-center text-[var(--color-teal)] border border-white/[0.08] group-hover:border-[var(--color-teal)]/30 transition-all duration-500 bg-[var(--color-obsidian)] relative">
                      <div className="text-[var(--color-teal)]/70 group-hover:text-[var(--color-teal)] transition-colors duration-300">
                        {node.icon}
                      </div>
                    </div>
                  </div>

                  <div className="mt-[12px] px-[12px] py-[4px] rounded-full bg-[var(--color-teal)]/5 border border-[var(--color-teal)]/10">
                    <span className="text-[11px] font-bold text-[var(--color-teal)]/60 group-hover:text-[var(--color-teal)] transition-colors uppercase tracking-wider">{node.desc}</span>
                  </div>
                </motion.div>
              )
            })}
          ...
          <div className="md:hidden relative">
            ...
            <div className="flex flex-col gap-[32px]">
              {nodes.map((node, i) => (
                ...
                >
                  <div className="relative z-10 w-[80px] h-[80px] rounded-full glass-card flex items-center justify-center text-[var(--color-teal)] border border-white/[0.08] bg-[var(--color-obsidian)] flex-shrink-0">
                    {node.icon}
                  </div>
                  <div>
                    ...
                    <div className="text-[18px] font-bold text-[var(--color-headline)] font-display mb-[4px]">{node.label}</div>
