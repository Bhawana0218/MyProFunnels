    ...
    <section id="testimonials" className="section-v relative z-10 overflow-hidden">
      <div className="section-container">
        ...
        >
          ...
          <div ref={heading.ref}>
            <h2 className={`text-4xl md:text-[48px] font-bold font-display tracking-[-0.03em] text-[var(--color-headline)] text-reveal ${heading.isRevealed ? 'revealed' : ''}`}>
          ...
          {[...testimonials, ...testimonials, ...testimonials].map((test, i) => (
            <div key={i} className="glass-card p-[32px] w-[380px] shrink-0 flex flex-col justify-between">
              <div>
                ...
                <p className="text-[var(--color-body)] mb-[24px] text-[14px] leading-relaxed">&ldquo;{test.quote}&rdquo;</p>
              </div>
              <div className="flex items-center gap-[16px]">
                <div className="w-[44px] h-[44px] rounded-full bg-gradient-to-br from-[var(--color-teal)]/20 to-[var(--color-graphite-light)] flex items-center justify-center text-[14px] font-bold text-[var(--color-headline)] border border-white/[0.06]">
                  {test.name.charAt(0)}
                </div>
                <div>
